...
Route::get('/console/types/delete/{id}', [TypesController::class, 'delete'])->where('id', '[0-9]+')->middleware('auth');
...
Route::get('console/types/edit/{id}', [TypesController::class, 'editForm'])->where('id', '[0-9]+')->middleware('auth');
Route::post('console/types/edit/{id}', [TypesController::class, 'edit'])->where('id', '[0-9]+')->middleware('auth');